    ...
    <el-container style="border: 1px solid #eee">
        ...
        <el-container style="min-height: 600px">
            ...
            <el-aside width="20%" style="background-color: rgb(238, 241, 246)">
                <el-menu :default-openeds="['5']" router :default-active="$route.path">
                    <el-submenu index="1">
                    ...
                    <el-submenu index="5">
                        ...
                        <el-menu-item-group>
                            <el-menu-item index="/exPerson" default-active>优秀员工展示</el-menu-item>
                        </el-menu-item-group>
                    </el-submenu>
                </el-menu>
            </el-aside>
                ...
                <el-card class="box-card">
                    ...
                    <div class="text item" >
                        ...
                        <el-breadcrumb separator-class="el-icon-arrow-right">
                            <!--:to="{ path: 'message' }"-->
                            <el-breadcrumb-item :to="{}">优秀员工</el-breadcrumb-item>
                            <el-breadcrumb-item ><a href="/message">优秀员工展示</a></el-breadcrumb-item>
                        </el-breadcrumb>

                        <el-divider></el-divider>
                        <el-table
                                :data="exPerson.slice((exPersonSetting.currentPage-1)*exPersonSetting.pageSize,exPersonSetting.currentPage*exPersonSetting.pageSize)"
                                style="width: 100%">
                            <el-table-column
                                    prop="name"
                                    label="成员名称"
                        ...
                        <el-pagination
                                ...
                                :current-page="exPersonSetting.currentPage"
                                :page-sizes="[10, 100]"
                                :page-size="exPersonSetting.pageSize"
                                layout="total, sizes, prev, pager, next, jumper"
                                :total="exPersonSetting.totalNum">
                        </el-pagination>
                        <p></p>
                    </div>
                </el-card>
            ...
            async initExPerson(){
                ...
                this.$axios({
                    ...
                    if(response.data.length <= 0){
                        ...
                        for(var num = 0 ; num < response.data.length ; num++){
                            _this.exPerson.push({
                                exPersonId:response.data[num].exPersonId,
                        ...
                        _this.exPersonSetting.totalNum=_this.exPerson.length;
                    }
                });
            },
