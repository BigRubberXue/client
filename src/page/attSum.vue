                ...
                <el-menu :default-openeds="['2']" router :default-active="$route.path">
                    ...
                    <el-submenu index="2">
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="/attSum" default-active >考勤总结</el-menu-item>
   ...
   -->
                    <div class="text item" >
                        ...
                        <el-breadcrumb separator-class="el-icon-arrow-right">
                            ...
                            <el-breadcrumb-item ><a href="/">考勤总结</a></el-breadcrumb-item>
                        </el-breadcrumb>
...
<script>
    export default {
        ...
        methods:{
            ...
            //                     attNode:response.data[num].attNode,
            ...
            async initSumAtt(){
                ...
                this.$axios({
                    method: 'post',
                    url: 'http://localhost:8083/recordPage/api/attDataSum',
                    params: {
                        userId : this.$session.get("myUserId"),
                    }
                    /*params: {
                    ...
                    console.log("getAttSum : "+response.data)
                    if(response.data.length <= 0){
                        console.log("fail");
                    }else{
                        for(var num = 0 ; num < response.data.length ; num++){
                            _this.attSumData.push({
                                mouthDataId:response.data[num].mouthDataId,
                                mouth: response.data[num].mouth,
                                userId: response.data[num].userId,
                                lateTime: response.data[num].lateTime,
                                signedTime:response.data[num].signedTime,
                            });
                        }
                        _this.attSumDataSetting.totalNum = response.data.length;
                        console.log("finish init "+response.data.length+" items about att");
                    }
                });
            },
