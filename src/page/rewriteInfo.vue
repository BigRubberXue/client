                ...
                <el-card class="box-card">
                    ...
                    <div class="text item" >
                        ...
                        <el-breadcrumb separator-class="el-icon-arrow-right">
                            <el-breadcrumb-item :to="{ path: '/info' }">个人数据</el-breadcrumb-item>
                            <el-breadcrumb-item ><a href="/info">个人信息修改</a></el-breadcrumb-item>
                        </el-breadcrumb>
                            ...
                            <el-container >
                                ...
                                <el-main width="80%">
                                    ...
                                    <el-container id="infoCard">
                                        ...
                                        <el-aside id="dataUser" width="50%">
                                            <!--<el-form id="infoCard-dataUser-info">
                                                &lt;!&ndash;
                                                    userId
                                                    username
                                                    password
                                            ...
                                            <div id="infoCard-dataUser-info" >
                                                <el-form label-width="80px" label-position="top">
                                                    <el-form-item label="名称" class="dataShowForm">
                                                        <el-input v-model="myUser.name"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="工位" class="dataShowForm">
                                                        <el-input v-model="myUser.station"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="联系方式" class="dataShowForm">
                                                        <el-input v-model="myUser.phone"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="工作邮箱" class="dataShowForm">
                                                        <el-input v-model="myUser.mail"></el-input>
                                                    </el-form-item>
                                                </el-form>
                                        ...
                                        <el-aside id="imgUser" width="50%" >
                                            ...
                                            <el-button id="changeData" type="primary" @click="changeData" :plain="true"> 确认修改</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            async changeData() {
                ...
                this.$axios({
                    method: 'post',
                    url: 'http://localhost:8083/infoPage/api/changeInfo',
